...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* Simple Magical Firefly Effect - Clean and Minimal */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        {/* Gentle floating fireflies */}
        {[...Array(isMobile ? 6 : 12)].map((_, i) => {
          const size = 2 + Math.random() * 1; // 2-3px size
          const duration = 15 + Math.random() * 10; // 15-25 second cycles
              ...
              <div 
                ...
                style={{
                  ...
                  background: `radial-gradient(circle, 
                    ...
                    rgba(183, 148, 244, 0.6) 50%, 
                    transparent 100%)`,
                  boxShadow: `0 0 ${size * 4}px ${size}px rgba(183, 148, 244, 0.3)`,
                  filter: 'blur(0.5px)'
                }}
              />
            </motion.div>
