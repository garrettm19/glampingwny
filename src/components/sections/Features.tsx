...
const Features: React.FC = () => {
  return (
    <section id="features" className="section bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      {/* Enhanced background decorative elements with teal theme */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[10%] right-[25%] w-3 h-3 bg-primary-500 rounded-full animate-pulse-glow animation-delay-700" />
        
        {/* Enhanced gradient orbs with teal theme */}
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-primary-200/20 to-blue-200/20 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-amber-200/20 to-primary-200/20 rounded-full blur-3xl" />
      </div>

      <div className="container-custom relative z-10">
        {/* Enhanced Introduction with teal accents */}
        <motion.div
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-block p-3 bg-gradient-primary rounded-full mb-6 shadow-glow"
          >
            <Sparkles className="w-8 h-8 text-white" />
          </motion.div>
          
          <h2 className="text-3xl md:text-4xl font-bold text-primary-900 mb-4">
            <span className="gradient-text">Your Go-to Glamping Experts</span> in Western New York!
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto mb-12">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="glass-card px-4 py-3 text-sm font-medium text-primary-900 hover-lift group cursor-pointer card-hover"
        ...
        {/* Enhanced Features Grid with teal theme */}
        <motion.div
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className={`glass-card rounded-xl overflow-hidden ${feature.shadowColor} hover:shadow-2xl transition-all duration-500 group card-hover`}
            >
              ...
              <div className="h-48 overflow-hidden relative">
                ...
                {/* Enhanced stats overlay with teal theme */}
                <motion.div
                  className="absolute bottom-4 left-4 bg-primary-500/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-white shadow-glow"
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="p-6">
                <div className={`${feature.color} w-14 h-14 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        {/* Enhanced Image Gallery Section with teal accents */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary-900 mb-4">
              See Our <span className="gradient-text">Magic</span> in Action
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="aspect-square overflow-hidden rounded-xl hover-lift group cursor-pointer card-hover"
                whileHover={{ scale: 1.02 }}
              >
                <img 
                  src={image} 
          ...
          {/* Enhanced View Gallery CTA with teal theme */}
          <motion.div
          ...
          >
            <Link
              to="/gallery"
              className="inline-flex items-center gap-2 text-primary-600 hover:text-primary-700 font-semibold group bg-primary-50 px-6 py-3 rounded-full hover:bg-primary-100 transition-all duration-300 hover:shadow-glow"
            >
              View Full Gallery
        ...
        {/* Enhanced Policies Section with teal theme */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        ...
        >
          <h2 className="text-2xl font-bold text-primary-900 mb-8 text-center">
            Important <span className="gradient-text">Policies</span> & Guidelines
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50/50 transition-colors duration-300 group"
              >
                <div className={`w-12 h-12 ${policy.color} rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
