          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <Phone className="w-5 h-5 mr-3 text-emerald-400 mt-1 flex-shrink-0" />
                <div>
                  <a 
              ...
              <div className="flex items-start">
                <Mail className="w-5 h-5 mr-3 text-emerald-400 mt-1 flex-shrink-0" />
                <div>
                  <a 
                    href="mailto:info@glampingwny.com"
                    className="text-gray-300 hover:text-emerald-400 transition-colors font-medium"
              ...
              <div className="flex items-start">
                <MapPin className="w-5 h-5 mr-3 text-emerald-400 mt-1 flex-shrink-0" />
                <div>
                  <address className="not-italic text-gray-300">
                    Buffalo Metro Area<br />
                    Hamburg, NY 14075
                  </address>
                  <p className="text-sm text-emerald-400 font-medium">FREE delivery within 20 miles</p>
                </div>
              </div>
            </div>
          </div>
